// Main app functionality for Maxim transportation app
...
orderBtn.addEventListener('click', function() {
    ...
    const destination = document.querySelector('.destination .location-label').textContent;
    const transportType = document.querySelector('.transport-option.active .transport-name').textContent;
    const paymentMethod = document.querySelector('.schedule-option-btn:first-child span').textContent;
    const timeOption = document.querySelector('.schedule-option-btn:nth-child(2) span').textContent;
...
pickupInput.addEventListener('blur', function() {
    this.setAttribute('placeholder', 'Titik penjemputan');
});
